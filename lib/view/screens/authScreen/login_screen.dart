                  ...
                  child: SingleChildScrollView(
                                     ...
                                     width: mediaQuerySize.width*0.5.w,
                                      decoration: BoxDecoration(
                                                        ...
                                                        image: DecorationImage(
                                                          fit: BoxFit.cover,
                                                          image: AssetImage('assets/pngs/rafiki.png')),
                    ...
                    child: Text('Sign in',style: TextStyle(fontFamily:'bold',fontSize: 36),),
                                  ...
                                  Padding(
                                    ...
                                    child: Text('Please enter your email and password',style:AppTextStyles.simpleText,),
                                  ),
                                  SizedBox(height: 10,),
                                  Align(
                                    alignment: Alignment.bottomLeft,
                                    child: Text(' Email',style: AppTextStyles.myCustom,)),
                            ...
                            return null;
                                 ...
                                 Align(
                                    alignment: Alignment.bottomLeft,
                                    child: Text(' Password',style: AppTextStyles.myCustom,)),
                                  CommonTextfield().customTextFormField(
                                  bgColor: AppColors.textFieldTextColor,
